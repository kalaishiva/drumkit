...
for(i=0; i<numOfDrumButton; i++){
   ...
   //detecting button when clicked                                                              //selected all the button using iteration
...
//detecting keyboard when its pressed                                                            

document.addEventListener('keypress', function(event){
    makesound(event.key);                                          //gives the key which we pressed example w
                                                                     /* console.log(event); */
